...
\begin{description}[leftmargin=0.7cm]
  ...
  \item[Séance 7] Ne jamais forcer un élève à retirer le masque : rester calme sans masque, 
    ne jamais retenir sa respiration, encadrant proche si le retrait est tenté. 
    Lestage complémentaire : l'ajuster individuellement, jamais de surlestage.
  ...
  \item[Séance 9] Accent sur la prévention de la surpression pulmonaire : ne jamais
    ...
    Bascule arrière avec scaphandre : vérifier l'absence d'un autre plongeur derrière
    avant le basculement, protéger le masque et le détendeur d'une main.
  \item[Séance 10] Exercices encadrés individuellement, procédures répétées calmement,
    jamais de simulation brutale. Toujours un échauffement apnée avant l'apnée
    expiratoire de 10 m ; encadrant à proximité immédiate lors de l'échange d'embout
    entre équipiers.
